...
class Department(models.Model):
    ...
    location = models.CharField(max_length=20, choices=Cities.choices, null=True, blank=True)
...
class Project(models.Model):
    ...
    start_date = models.DateField(default=date.today, null=True, blank=True, verbose_name="Start Date")
